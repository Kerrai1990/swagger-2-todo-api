...
func NewTodoListAPI(spec *loads.Document) *TodoListAPI {
	return &TodoListAPI{
		...
		AppComHemmitkerraiTodoConsumer: runtime.ConsumerFunc(func(r io.Reader, target interface{}) error {
			return errors.NotImplemented("appComHemmitkerraiTodo consumer has not yet been implemented")
		}),

		AppComHemmitkerraiTodoProducer: runtime.ProducerFunc(func(w io.Writer, data interface{}) error {
		...
		TodosDeleteIDHandler: todos.DeleteIDHandlerFunc(func(params todos.DeleteIDParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.DeleteID has not yet been implemented")
		}),
		...
		TodosPostHandler: todos.PostHandlerFunc(func(params todos.PostParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.Post has not yet been implemented")
		}),
		TodosPutIDHandler: todos.PutIDHandlerFunc(func(params todos.PutIDParams) middleware.Responder {
			return middleware.NotImplemented("operation todos.PutID has not yet been implemented")
		}),
	}
}
...
type TodoListAPI struct {
	...
	// AppComHemmitkerraiTodoConsumer registers a consumer for the following mime types:
	//   - app/com.hemmitkerrai.todo
	AppComHemmitkerraiTodoConsumer runtime.Consumer

	// AppComHemmitkerraiTodoProducer registers a producer for the following mime types:
	//   - app/com.hemmitkerrai.todo
	AppComHemmitkerraiTodoProducer runtime.Producer
...
func (o *TodoListAPI) Validate() error {
	...
	if o.AppComHemmitkerraiTodoConsumer == nil {
		unregistered = append(unregistered, "AppComHemmitkerraiTodoConsumer")
	}

	if o.AppComHemmitkerraiTodoProducer == nil {
		unregistered = append(unregistered, "AppComHemmitkerraiTodoProducer")
	}
...
func (o *TodoListAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
	...
	for _, mt := range mediaTypes {
		switch mt {
		case "app/com.hemmitkerrai.todo":
			result["app/com.hemmitkerrai.todo"] = o.AppComHemmitkerraiTodoConsumer
		}
...
func (o *TodoListAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
	...
	for _, mt := range mediaTypes {
		switch mt {
		case "app/com.hemmitkerrai.todo":
			result["app/com.hemmitkerrai.todo"] = o.AppComHemmitkerraiTodoProducer
		}
